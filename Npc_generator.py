...
class NPCGenerator:
    ...
    def respuesta(self, prompt):
        ...
        system_message = {
            "role": "system",
            "content": f"""Eres un NPC llamado {self.npc_name} en un juego de aventuras. Tu tarea es interactuar con el jugador de manera coherente, natural y en contexto con el historial de conversaciones. Siempre debes comportarte como un NPC, manteniendo un tono apropiado y actuando dentro de los límites de tu rol en el juego. 
